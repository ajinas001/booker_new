...
const reelsData = [
    ...
    {
        id: 2,
        title: "Dubai Investment Funds Reality Want to invest in Dubai real estate but don't know how to legally transfer your funds from India?",
        subtitle: "Booker Accounting & Consultancy",
                        ...
                        >
                            ...
                            <div className="absolute inset-0 w-full h-full z-0">
                                <img
                                    src={reel.thumbnail}
                                    alt={reel.title}
                                    className="w-full h-full object-cover transition-transform duration-500 ease-out group-hover:scale-103 will-change-transform"
                                    loading="lazy"
                                />
                            </div>
                            ...
                            <div className="absolute inset-0 flex items-center justify-center z-20 transition-all duration-300 group-hover:bg-black/10">
                                <div className="relative text-white transition-all duration-300 group-hover:scale-105 flex items-center justify-center w-20 h-20 rounded-full bg-white/10 backdrop-blur-md border border-white/20 shadow-2xl">
                                    <svg viewBox="0 0 512 512" fill="currentColor" className="w-8 h-8 ml-1 text-white filter drop-shadow-[0_2px_4px_rgba(0,0,0,0.15)]">
