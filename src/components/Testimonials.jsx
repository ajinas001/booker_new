...
function HeroBg() {
  ...
  return (
    <div
      ref={ref}
      className="sticky top-0 h-screen h-[100dvh] h-[100svh] overflow-hidden z-0 flex items-center justify-center"
    >
      ...
      <div className="relative z-10 text-center text-white px-5 sm:px-6 max-w-3xl mx-auto">
        <motion.p
          ...
          className="text-[11px] sm:text-xs uppercase tracking-[0.2em] text-teal-300 font-semibold mb-4"
        >
        ...
        <motion.h1
          ...
          className="text-3xl sm:text-5xl lg:text-6xl font-semibold leading-tight tracking-tight mb-5"
        >
          Real Results for
          <br />
        ...
        <motion.p
          ...
          className="text-base sm:text-lg text-white/75 leading-relaxed max-w-xl mx-auto"
        >
      ...
      <motion.div
        ...
        className="absolute bottom-6 sm:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/50"
      >
...
export default function Testimonials() {
  return (
    ...
    <div className="relative">
      ...
      <div
        className="relative z-10 bg-white rounded-t-[24px] sm:rounded-t-[36px] -mt-6 sm:-mt-10 lg:-mt-12 overflow-hidden"
        style={{
          boxShadow: "0 -12px 48px rgba(0,0,0,0.14)",
        }}
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-14 py-14 sm:py-18 lg:py-24">
          ...
          <section className="mb-16 sm:mb-20 lg:mb-28">
            ...
            >
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-black leading-tight mb-2">
                Success{" "}
            ...
            >
              {testimonials.map((t, idx) => (
                <motion.div
                  ...
                  className="group relative flex flex-col justify-between p-6 sm:p-8 bg-gradient-to-b from-neutral-50 to-neutral-100/40 hover:from-white hover:to-neutral-50/20 rounded-[1.5rem] sm:rounded-[2rem] border border-neutral-200/60 hover:border-[#1f626d]/30 hover:shadow-2xl hover:shadow-[#1f626d]/8 transition-all duration-500"
                >
                  {/* Ambient glow */}
            ...
            >
              <Link
                ...
                className="group inline-flex items-center gap-3 sm:gap-4 px-6 sm:px-10 py-3.5 sm:py-4 rounded-full border border-gray-300 bg-transparent text-gray-900 text-sm sm:text-base font-semibold hover:border-[#1f626d] transition-all duration-300"
              >
                <Image
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mb-10"
          >
            {results.map(({ icon: Icon, label, value }, idx) => (
              <motion.div
                key={idx}
                variants={cardSlideUp}
                className="bg-[#1f626d] p-5 sm:p-7 rounded-2xl text-white shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
              >
                <Icon className="w-8 h-8 sm:w-10 sm:h-10 mb-3 sm:mb-4 opacity-85" />
                <p className="text-xs sm:text-sm text-white/75 mb-1">{label}</p>
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="bg-[#f0faf7] rounded-3xl px-6 sm:px-12 py-10 sm:py-12 mb-8"
          >
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="bg-[#1f626d] text-white rounded-3xl px-6 sm:px-12 py-10 sm:py-12"
          >
            ...
            <div className="space-y-6 sm:space-y-7">
              {whyItems.map(({ title, desc }, idx) => (
                ...
                >
                  ...
                  <div>
                    <h4 className="font-bold text-sm sm:text-[15px] mb-1">{title}</h4>
                    <p className="text-white/80 text-sm sm:text-[15px] leading-relaxed">{desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
