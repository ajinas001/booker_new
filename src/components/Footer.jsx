...
const socialLinks = [
  ...
  { icon: FaInstagram, href: "https://www.instagram.com/booker_accounting", label: "Instagram" },
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10 items-start">
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-sm font-semibold tracking-wide text-gray-200">Services</h3>
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-sm font-semibold tracking-wide text-gray-200">Company</h3>
            <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-3 border-t md:border-t-0 pt-6 md:pt-0 border-gray-800">
            ...
            <div className="flex items-start gap-3 text-gray-400">
              <FaLocationDot size={16} className="text-teal-400 shrink-0 mt-0.5" />
        ...
        <div className="mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center border-t border-gray-800 gap-6">
          <p className="text-xs text-gray-500 text-center sm:text-left order-2 sm:order-1">
            &copy; {new Date().getFullYear()} Booker Accounting and Consulting. All rights reserved.
          </p>
