...
export default function BusinessSupportPage() {
  ...
  return (
    <>
      <Head>
        <title>Business Support Services — BAC</title>
        <meta
          name="description"
          content="Expert business support services for UAE businesses — mainland company formation, freezone setup, company secretarial, liquidation, ICV consultancy, and PRO services."
        />
        <meta
          name="keywords"
          content="business setup UAE, mainland company formation Dubai, freezone business setup, PRO services UAE, ICV consultancy, company liquidation UAE"
        />
        <meta name="robots" content="index,follow" />
        <link
          rel="canonical"
          href="https://yourdomain.com/services/business-support"
        />
        <meta property="og:title" content="Business Support Services — BAC" />
        <meta
          property="og:description"
          content="Simplified Setup. Seamless Operations. Continuous Compliance. End-to-end business support for UAE businesses."
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "BAC Business Support",
              url: "https://yourdomain.com/services/business-support",
              description:
                "End-to-end business support solutions built for UAE businesses.",
            }),
          }}
        />
      </Head>
